...
[data1 txt1 raw1]=xlsread('D:\ZZZ\Manuscripts\Image_Gene\data\all_gene_disease_associations\NMO_and_MS.xlsx',3);
[data2 txt2 raw2]=xlsread('D:\ZZZ\Manuscripts\Image_Gene\data\all_gene_disease_associations\NMO_and_MS.xlsx',4);
[data3 txt3 raw3]=xlsread('D:\ZZZ\Manuscripts\Image_Gene\data\all_gene_disease_associations\NMO_and_MS.xlsx',5);
[data4 txt4 raw4]=xlsread('D:\ZZZ\Manuscripts\Image_Gene\data\all_gene_disease_associations\NMO_and_MS.xlsx',1);
% 
% %NDI
Str='NDI';
savepath='D:\ZZZ\Manuscripts\Image_Gene\Gradient_test\Lifespan_new\Results\NDI\BP'
[data_pls_p txt_pls_p raw_pls_p]=xlsread('D:\ZZZ\Manuscripts\Image_Gene\Gradient_test\Lifespan_new\Results\NDI\BP\NDI_Pos_ALL_GO.xlsx');
[data_pls_n txt_pls_n raw_pls_n]=xlsread('D:\ZZZ\Manuscripts\Image_Gene\Gradient_test\Lifespan_new\Results\NDI\BP\NDI_Neg_ALL_GO.xlsx');

% % % %ODI
% Str='ODI';
% savepath='D:\ZZZ\Manuscripts\Image_Gene\Gradient_test\Lifespan_new\Results\ODI\BP'
% [data_pls_p txt_pls_p raw_pls_p]=xlsread('D:\ZZZ\Manuscripts\Image_Gene\Gradient_test\Lifespan_new\Results\ODI\BP\ODI_Pos_ALL_GO.xlsx');
% [data_pls_n txt_pls_n raw_pls_n]=xlsread('D:\ZZZ\Manuscripts\Image_Gene\Gradient_test\Lifespan_new\Results\ODI\BP\ODI_Neg_ALL_GO.xlsx');
% % 
% %WMH_volume
% Str='WMH_volume';
% savepath='D:\ZZZ\Manuscripts\Image_Gene\Gradient_test\Lifespan\Results\Lesion_volume\BP'
% [data_pls_p txt_pls_p raw_pls_p]=xlsread('D:\ZZZ\Manuscripts\Image_Gene\Gradient_test\Lifespan\Results\Lesion_volume\BP\Multi_gene_list_PLS_Pos.xlsx');
% [data_pls_n txt_pls_n raw_pls_n]=xlsread('D:\ZZZ\Manuscripts\Image_Gene\Gradient_test\Lifespan\Results\Lesion_volume\BP\Multi_gene_list_PLS_Neg.xlsx');
...
savepath='D:\ZZZ\Manuscripts\Image_Gene\Gradient_test\Lifespan_new\Results\NDI'
cd(savepath);
