clear all;clc;
% %NDI
datapath='D:\ZZZ\Manuscripts\Image_Gene\Gradient_test\Lifespan_new';
cd(datapath);
[data1 txt1 raw1]=xlsread('lifespan_ICVF.xls',1);
savepath='D:\ZZZ\Manuscripts\Image_Gene\Gradient_test\Lifespan_new\Results\NDI';

% %ODI
% datapath='D:\ZZZ\Manuscripts\Image_Gene\Gradient_test\Lifespan_new';
% cd(datapath);
% [data1 txt1 raw1]=xlsread('lifespan_ODI.xls',1);
% savepath='D:\ZZZ\Manuscripts\Image_Gene\Gradient_test\Lifespan_new\Results\ODI';

% % %WHM_volume
% datapath='D:\ZZZ\Manuscripts\Image_Gene\Gradient_test\Lifespan_new';
% cd(datapath);[data1 txt1 raw1]=xlsread('lifespan_WMH_volume.xls',1);
% savepath='D:\ZZZ\Manuscripts\Image_Gene\Gradient_test\Lifespan_new\Results\Lesion_volume';
...
cell_data=importdata('D:\ZZZ\Manuscripts\Image_Gene\freesurfer_value_extraction\41467_2020_17051_MOESM8_ESM.xlsx');
