...
rm(list=ls())
datapath='D:/ZZZ/Manuscripts/Gradient_study/lifespan_gradient/codes/code_github/data/NODDI_ring_values';
savepath='D:/ZZZ/Manuscripts/Gradient_study/lifespan_gradient/codes/code_github/Results/LME_and_Clinical_Association';
...
Clinical[,'WM_NODDI_whole_lelvel']<-rowMeans(data_zscore)
...
WM_NODDI_whole_lelvel<-Clinical$WM_NODDI_whole_lelvel
...
Cor_Group<-New_group
Cor_data<-cbind(Result4$individual$`(Intercept)`,Result4$individual$ring_dist,Age,Sex,TIV,GM,WM,WM_ICVF,WM_OD,Lesion_vol,
                MMSE,MOCA,Cor_Group,Protocol,Disease_Duration_years,Education_years,WM_NODDI_whole_lelvel)
colnames(Cor_data)<-c('Intercept','Slope','Age','Sex','TIV','GMV','WMV','WM_ICVF','WM_OD','Lesion_volume',
...
fit0<-lm(Slope~Age+Sex+Protocol+WM_NODDI_whole_lelvel,data=Cor_data,subset=(Cor_data$Group=='Elderly'))
R1<-summary(fit0)
R2<-confint(fit0)
...
fit0<-lm(Slope~GMV+Age+Sex+TIV+Protocol+WM_NODDI_whole_lelvel,data=Cor_data,subset=(Cor_data$Group=='Elderly'))
R1<-summary(fit0)
R2<-confint(fit0)
...
fit0<-lm(Slope~WMV+Age+Sex+TIV+Protocol+WM_NODDI_whole_lelvel,data=Cor_data,subset=(Cor_data$Group=='Elderly'))
R1<-summary(fit0)
R2<-confint(fit0)
...
fit0<-lm(Slope~Lesion_volume+Age+Sex+Protocol+WM_NODDI_whole_lelvel,data=Cor_data,subset=(Cor_data$Group=='Elderly'))
R1<-summary(fit0)
R2<-confint(fit0)
...
fit0<-lm(Slope~MOCA+Age+Sex+Protocol+WM_NODDI_whole_lelvel+Education,data=Cor_data,subset=(Cor_data$Group=='Youth'))
R1<-summary(fit0)
R2<-confint(fit0)
...
fit0<-lm(Slope~MOCA+Age+Sex+Protocol+WM_NODDI_whole_lelvel+Education,data=Cor_data,subset=(Cor_data$Group=='Middle'))
R1<-summary(fit0)
R2<-confint(fit0)
...
fit0<-lm(Slope~MOCA+Age+Sex+Protocol+WM_NODDI_whole_lelvel+Education,data=Cor_data,subset=(Cor_data$Group=='Elderly'))
R1<-summary(fit0)
R2<-confint(fit0)
...
fit0<-lm(Slope~MOCA+Age+Sex+Protocol+WM_NODDI_whole_lelvel+Education,data=Cor_data,subset=(Cor_data$Group=='AD'))
R1<-summary(fit0)
R2<-confint(fit0)
...
fit0<-lm(Slope~MOCA+Age+Sex+Protocol+WM_NODDI_whole_lelvel+Education,data=Cor_data,subset=(Cor_data$Group=='PD'))
R1<-summary(fit0)
R2<-confint(fit0)
...
fit0<-lm(Slope~MOCA+Age+Sex+Protocol+WM_NODDI_whole_lelvel+Education,data=Cor_data,subset=(Cor_data$Group=='SVD'))
R1<-summary(fit0)
R2<-confint(fit0)
...
fit0<-lm(Slope~MOCA+Age+Sex+Protocol+WM_NODDI_whole_lelvel+Education,data=Cor_data,subset=(Cor_data$Group=='MS'))
R1<-summary(fit0)
R2<-confint(fit0)
...
fit0<-lm(Slope~MMSE+Age+Sex+Protocol+WM_NODDI_whole_lelvel+Education,data=Cor_data,subset=(Cor_data$Group=='Youth'))
R1<-summary(fit0)
R2<-confint(fit0)
...
fit0<-lm(Slope~MMSE+Age+Sex+Protocol+WM_NODDI_whole_lelvel+Education,data=Cor_data,subset=(Cor_data$Group=='Middle'))
R1<-summary(fit0)
R2<-confint(fit0)
...
fit0<-lm(Slope~MMSE+Age+Sex+Protocol+WM_NODDI_whole_lelvel+Education,data=Cor_data,subset=(Cor_data$Group=='Elderly'))
R1<-summary(fit0)
R2<-confint(fit0)
...
fit0<-lm(Slope~MMSE+Age+Sex+Protocol+WM_NODDI_whole_lelvel+Education,data=Cor_data,subset=(Cor_data$Group=='AD'))
R1<-summary(fit0)
R2<-confint(fit0)
...
fit0<-lm(Slope~MMSE+Age+Sex+Protocol+WM_NODDI_whole_lelvel+Education,data=Cor_data,subset=(Cor_data$Group=='PD'))
R1<-summary(fit0)
R2<-confint(fit0)
...
fit0<-lm(Slope~MMSE+Age+Sex+Protocol+WM_NODDI_whole_lelvel+Education,data=Cor_data,subset=(Cor_data$Group=='SVD'))
R1<-summary(fit0)
R2<-confint(fit0)
...
fit0<-lm(Slope~MMSE+Age+Sex+Protocol+WM_NODDI_whole_lelvel+Education,data=Cor_data,subset=(Cor_data$Group=='MS'))
R1<-summary(fit0)
R2<-confint(fit0)
