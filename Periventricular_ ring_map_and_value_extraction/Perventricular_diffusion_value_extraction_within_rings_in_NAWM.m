# note: # note: this code is used to extract the NODDI values in each ring (except for the first ring) 
...
for i=1:length(nii);
    tem_list=list(:,:,i);
    xlswrite('NAWM_Distance_Results.xlsx',tem_list,i);
end
